...
"minNbSurvival", "nbConfigurations", "mu", "codeEvolution", "codeEvolutionConfig",
"codeEvolutionVariants", "confidence"), type = c("x", "x", "x",
"x", "p", "p", "p", "p", "x", "x", "p", "p", "p", "s", "p", "p",
"b", "p", "p", "x", "i", "b", "s", "i", "i", "i", "p", "p", "s",
"i", "i", "x", "x", "p", "b", "i", "i", "i", "r", "r", "i", "b",
"b", "s", "b", "i", "i", "b", "r", "b", "i", "i", "x", "b", "b",
"s", "s", "i", "i", "i", "b", "b", "b", "i", "i", "i", "i", "i",
"b", "p", "i", "r"), short = c("-h", "-v", "-c", "-i", "", "-s",
"", "-p", "", "", "", "-l", "", "", "", "", "", "", "", "", "",
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
"", "", "", "", "", "", "", "-q", "", "", "", "", "-e", "", "",
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
...
"--test-iteration-elites", "--test-type", "--first-test", "--block-size",
"--each-test", "--target-runner", "--target-runner-launcher",
"--target-cmdline", "--target-runner-retries", "--target-runner-timeout",
...
"--mu", "--code-evolution", "--code-evolution-config", "--code-evolution-variants",
"--confidence"), default = c(NA, NA, NA, "", "", "./scenario.txt",
...
"0", "0", "0", "0", "5", "FALSE", "./code-evolution.json", "5",
"0.95"), domain = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "F-test,t-test,t-test-holm,t-test-bonferroni",
...
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
    ...
    "Enable automatic code evolution using LLMs. When enabled, irace-evo will generate and evolve algorithm variants.",
    "Path to the code evolution configuration file containing source files, build settings, and LLM configuration.",
    "Number of code variants to generate and evaluate per iteration.",
...
"boundAsTimeout", "postselection", "aclib", "nbIterations", "nbExperimentsPerIteration",
"minNbSurvival", "nbConfigurations", "mu", "codeEvolution", "codeEvolutionConfig",
"codeEvolutionVariants", "confidence"), class = "data.frame")
...
"boundAsTimeout", "postselection", "aclib", "nbIterations", "nbExperimentsPerIteration",
"minNbSurvival", "nbConfigurations", "mu", "codeEvolution", "codeEvolutionConfig",
"codeEvolutionVariants", "confidence")
